<div class="welcome-header clearfix">
    <div class="welcome-intro">
        ...
        <div class="free-pro-demos">
            <a class="button button-primary" href="https://demo.hashthemes.com/total/" target="_blank"><span class="dashicons dashicons-visibility"></span><?php esc_html_e('Free Demos', 'total'); ?></a>
    ...
    <div class="welcome-promo-banner">
        <a class="welcome-promo-offer" href="<?php echo esc_url('https://hashthemes.com/wordpress-theme/total-plus/?utm_source=wordpress&utm_medium=total-welcome&utm_campaign=total-upgrade'); ?>" target="_blank"><?php echo esc_html__('Unlock all the possibitlies with Total Plus.', 'total'); ?></a>
...
<div class="welcome-nav-wrapper clearfix">
    <?php foreach ($tabs as $section_id => $label) : ?>
        ...
        ?>
        <a href="<?php echo esc_url(admin_url('themes.php?page=total-welcome&section=' . $section_id)); ?>" class="<?php echo esc_attr($nav_class); ?>" >
