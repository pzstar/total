 ...
 * them in a bullet list. Rendered under the relevant free section, where the
 * user is already looking at that part of the site and the gap is most obvious.
 */
class Total_Pro_Preview_Control extends WP_Customize_Control {
                ...
                <?php if ($this->more_count > 0) { ?>
                    <a class="ht--pro-preview-item ht--pro-preview-more" href="<?php echo esc_url($this->upgrade_url); ?>" target="_blank" rel="noopener">
                        <span><?php
                            ...
                            printf(esc_html__('+%d more', 'total'), absint($this->more_count));
                            ?></span>
                    </a>
                <?php } ?>
            </div>
