...
$total_pro_features = '<ul>
	...
	<a class="ht-implink button button-primary" href="http://localhost:8888/total/wp-admin/admin.php?page=total-welcome&section=free_vs_pro" target="_blank">' . esc_html__("Comparision - Free Vs Pro", "total") . '</a>';
